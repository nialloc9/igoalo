    ...
    <div class="panel panel-default">
        ...
        <div id="collapse<?php echo htmlspecialchars($status_goal->id); ?>" class="panel-collapse collapse">
            <div class="panel-body">
                ...
                <?php endif; ?>
                <p class="goal_text">Created at: <a href='#'><?php echo htmlspecialchars($status_goal->created_at); ?></a></p><br>
                ...
                <input type="hidden" class="timestamp" id="goal_time_per_input_hidden<?php echo htmlspecialchars($status_goal->id); ?>">
            </div>
        </div>
    </div>
</div>