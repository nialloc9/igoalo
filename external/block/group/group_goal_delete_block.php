        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <div class="progress">
                    <div class="progress-bar progress-bar-striped active" id="progress_delete<?php echo htmlspecialchars($goal->id); ?>" role="progressbar"
                         aria-valuenow="<?php echo htmlspecialchars($goal->goal_per_completed); ?>" aria-valuemin="0" aria-valuemax="100" style="width:<?php echo htmlspecialchars($goal->goal_per_completed); ?>%">
            ...
            <div id="collapse_delete<?php echo htmlspecialchars($goal->id); ?>" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <p class="goal_text">Created at: <p class="time"><?php echo htmlspecialchars($goal->created_at); ?></p></p><br>

                    <input type="hidden" name="group_goal_delete_id" value="<?php echo htmlspecialchars($goal->id); ?>">
                    <input type="text" name="goal_delete_group_id" value="<?php echo $group_id; ?>">
