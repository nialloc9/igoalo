    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title goal_block_title">
                <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo htmlspecialchars($goal->id); ?>">
        ...
        <div id="collapse<?php echo htmlspecialchars($goal->id); ?>" class="panel-collapse collapse">
            <div class="panel-body">
                <?php if(!empty($goal->about)): ?>
                    <p class="goal_text"><strong>About:</strong> <?php echo htmlspecialchars($goal->about); ?>.<br>
