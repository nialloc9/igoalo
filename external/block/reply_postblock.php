<form role="form" action="#" method="post">
    <div class="form-group">
        <textarea name="reply_text" id='reply<?php echo htmlspecialchars($status->id); ?>' class="form-control" rows="2" placeholder="Reply to this status"></textarea>
    </div>
    ...
    <input type="hidden" class="timestamp" name="post_time" id="post_time<?php echo htmlspecialchars($status->id); ?>"/>
</form>
